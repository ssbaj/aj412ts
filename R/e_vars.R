...
if(explaining==0) {
cat('\014')
cat(" \033[1;32m# VARselect lag 갯수의 결정. lag갯수가 K일 경우:\033[0m", '\n')
cat(" \033[1;32m# 	VAR lag 갯수 = K \033[0m", '\n')
cat(" \033[1;32m# 	ca.jo 요한센 공적분 검정. ca.jo의 최소 lag갯수는 2개 \033[0m", '\n')
cat(" \033[1;32m# 	      K가 3개 이상일 때의 ca.jo lag 갯수 = K-1 \033[0m", '\n')
cat(" \033[1;32m# 	VECM lag 갯수 = K-1 \033[0m", '\n')
cat(" \033[1;32m# \033[0m", '\n')
cat(" \033[1;32m# causality 그랜저인과관계. VAR결과 필요 \033[0m", '\n')
cat(" \033[1;32m# VARselect lag차수(lag order) 결정. stationary자료 필요 \033[0m", '\n')
cat(" \033[1;32m# ca.jo 요한센 공적분관계. 차분하지 않은 자료 필요 \033[0m", '\n')
cat(" \033[1;32m#  \033[0m", '\n')
...
cat("  따라서, ecdet = 'trend'는 상수 항과 추세 항이 모두 포함된 공적분 관계를 고려하여 검정을 수행 ", '\n')
cat("   ", '\n')
