...
cat(" \033[1;32m YoY_changes = {24년1월-23년1월, 24년2월-23년2월, ... , 24년12월-23년12월} \033[0m ", '\n')
cat(" \033[1;32m 변화율 = { YoY_changes/Adata$data_value[1:(자료수-12)] } \033[0m ", '\n')
cat(" \033[1;32m YoY_changes2<-ts(변화율, start=c(1966,1), f=12) \033[0m  ", '\n')
